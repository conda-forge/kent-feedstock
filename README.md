...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/kent-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15007&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/kent-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `kent` can be installed with:

```
conda install kent
```

It is possible to list all of the versions of `kent` available on your platform with:
